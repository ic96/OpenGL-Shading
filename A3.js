...
var mode = Part.TOON// current mode
...
var phongMaterial = new THREE.ShaderMaterial({
  uniforms: {
    // TODO: pass in the uniforms you need
      lightDir: lightDirectionUniform,
...
loadOBJ(Part.ANISOTROPIC, 'obj/armadillo.obj', anisotropicMaterial,1,-5,1,0.5,1,0,0);
loadOBJ(Part.ANISOTROPIC, 'obj/bunny.obj', anisotropicMaterial,0.5,3,0.2,4,0,0,0);
loadOBJ(Part.ANISOTROPIC, 'obj/car.obj', anisotropicMaterial,0.05,-5,0,-5,-1.58,0,0);
loadOBJ(Part.ANISOTROPIC, 'obj/male.obj', anisotropicMaterial,0.03,3,0,-3,0,0,0);
...
loadOBJ(Part.TOON, 'obj/armadillo.obj', toonMaterial,1,-5,1,0.5,1,0,0);
loadOBJ(Part.TOON, 'obj/bunny.obj',  toonMaterial,0.5,3,0.2,4,0,0,0);
loadOBJ(Part.TOON, 'obj/car.obj', toonMaterial,0.05,-5,0,-5,-1.58,0,0);
loadOBJ(Part.TOON, 'obj/male.obj', toonMaterial,0.03,3,0,-3,0,0,0);
